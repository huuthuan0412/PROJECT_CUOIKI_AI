...
class LoginPage:
    def __init__(self, window):
        ...
        self.window.title('PROJECT AI-Nhận dạng góc xoay gương măt')
        ...
        #Tài khoản
        self.username_label = Label(self.lgn_frame, text="Tên tài khoản", bg="#040405", fg="#4f4e4d",
        ...
        self.login = Button(self.lgn_button_label, text='Đăng nhập',command=kiemtra, font=("yu gothic ui", 13, "bold"), width=25, bd=0,
        ...
        self.forgot_button = Button(self.lgn_frame, text="Quên mật khẩu?",command=quenmk,
        ...
        def taotk():
            window.destroy()
            import taoTK
        self.sign_label = Label(self.lgn_frame, text='Tạo tài khoản?', font=("yu gothic ui", 11, "bold"),
                                relief=FLAT, borderwidth=0, background="#040405", fg='white')
        self.sign_label.place(x=550, y=560)

        self.signup_img = ImageTk.PhotoImage(file='images\\register.png')
        self.signup_button_label = Button(self.lgn_frame, image=self.signup_img, bg='#98a65d', cursor="hand2",command=taotk,
        ...
        #Lưu mật khẩu
        Checkbutton(window).place(x=750, y=580)
